  ...
  return (
    <div>
      ...
      <div className='px-2 mx-auto min-h-screen'>
        <h1 className='text-2xl font-bold text-center py-10 '>Post Add</h1>
        ...
        <form className='flex flex-col max-w-xl lg:max-w-5xl w-full mx-auto' onSubmit={handleSubmit}>
          ...
          <Button type='submit' className='my-10 w-md flex mx-auto bg-amber-900 hover:bg-amber-900 hover:opacity-85'>{loading ? 'Loading...':'Post the Add'}</Button>
        </form>
